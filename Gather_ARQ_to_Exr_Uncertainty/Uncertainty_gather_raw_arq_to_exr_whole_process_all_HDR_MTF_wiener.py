...
image_save_path = image_root_path + '_uncertainty_HDR_MTF_wiener'
...
for gather_index in tqdm(range(len(files_list))):
    ...
    HDR_img_mean, HDR_img_var, unsaturated = HDRutils.merge_uncertainty(files, demosaic_first=False, color_space='raw',
